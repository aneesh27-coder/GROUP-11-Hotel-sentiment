🌟 Hotel Review Sentiment Analysis – GenAI Powered Machine Learning Project 🏨 Transforming Hotel Customer Feedback into Actionable Insights Using AI
...
🔥 Key Features ✔️ End-to-End Sentiment Analysis System
...
📂 Project Structure Hotel-Sentiment-Analysis/ │── app.py # Flask backend for handling requests and predictions │── README.md # Complete project documentation │ ├── static/ │ └── style.css # Front-end styling │ ├── templates/ │ ├── index.html # Main page for user review input │ └── result.html # Prediction display page │ ├── dataset/ │ └── hotel_reviews.csv # Dataset used to train the model │ └── notebook/ └── hotel_sentiment.ipynb # Full ML training + EDA notebook
...
High-quality text preprocessing is critical for sentiment analysis. This project uses a multi-step cleaning pipeline:
